...
def process_tractors_and_combines(root, num_points):
    ...
    train_seq = ['0010', '1001', '1003', '1102', '1103', '1104', '1105', '1106', '1107']
    val_seq = ['2101', '2108']
    test_seq = []
...
if __name__ == "__main__":
    ...
    # For debugging
    process_tractors_and_combines(root='/work/3dgs-drive/data/agco_all_real_only/3000/', num_points=30000)
