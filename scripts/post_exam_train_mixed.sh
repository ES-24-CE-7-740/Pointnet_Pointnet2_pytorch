...
#SBATCH --mem=60G
#SBATCH --output=post_exam_combined_1200_%j.out
#SBATCH --error=post_exam_combined_1200_%j.err
...
srun singularity exec --nv --bind /home:/home ~/containers/ptv3-container.sif \
	...
	--epoch 32 \
	--gpu='0,1' \
	--log_dir post_exam_combined \
	--root_folder /home/agco/datasets/tractors_and_combines_combined/1200/pointnet_combined
